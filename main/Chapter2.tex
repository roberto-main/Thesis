...
(where observations are grouped by region/continent) this assumption is violated.\\
...
\begin{itemize}
    ...
    \item $\beta_1 \cdot GNI_i$ represents the linear effect of GNI per capita;
...
The complete R model specification is provided in Appendix C (Model \ref{lst:gamm}).
\end{table}
