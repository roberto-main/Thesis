...
with a Generalized Additive Mixed Model (GAMM), which accounts 
for the hierarchical structure of the data and allows for the 
...
A notable limitation concerns the Stringency Index, which proved 
